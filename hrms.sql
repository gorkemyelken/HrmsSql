...
CREATE TABLE public.confirm_by_system_employee
(
    id integer NOT NULL,
    employer_id integer,
    is_confirm boolean,
    system_employee_id integer,
    PRIMARY KEY (id)
);

CREATE TABLE public.confirm_by_system_employees
(
...
ALTER TABLE public.confirm_by_system_employees
